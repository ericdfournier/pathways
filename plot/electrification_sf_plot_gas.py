...
data_root = '/users/edf/repos/cec_ng/pathways/data/sf_electrification/gas/'
...
root = root = '/Users/edf/repos/cec_ng/pathways/fig/sf_electrification/gas/'

vlim_month = (-np.round(fhe_high.monthly_baseline_change.max().max() / 1000000, 3),
              np.round(fhe_high.monthly_baseline_change.max().max() / 1000000, 3))

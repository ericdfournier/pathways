...
field = 'Site Energy|Lg. Appl. (G)'
unit = 'btu'
p, nm = utils.ReadBEopt(directory, field, unit)
root = '/Users/edf/repos/cec_ng/pathways/fig/mf_electrification/gas/'
...
data_root = '/users/edf/repos/cec_ng/pathways/data/mf_electrification/gas/large_appliances/'
